...
public class LWeatherDB 
{
	...
	*/
	...
	private static LWeatherDB LWeatherDB;
	...
	*/
	...
	LWeatherOpenHelper dbHelper = new LWeatherOpenHelper(context,
	...
	* 获取CoolWeatherDB的实例。
	*/
	public synchronized static LWeatherDB getInstance(Context context) {
	if (LWeatherDB == null) {
