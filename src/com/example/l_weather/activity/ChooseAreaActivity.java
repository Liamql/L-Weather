...
public class ChooseAreaActivity extends Activity 
{
	...
	*/
	...
	{
		provinceList = LWeatherDB.loadProvinces();
	...
	*/
	private void queryCities() {
		cityList = LWeatherDB.loadCities(selectedProvince.getId());
		if (cityList.size() > 0) {
		dataList.clear();
	...
	*/
	...
	countyList = LWeatherDB.loadCounties(selectedCity.getId());
	...
	private void queryFromServer(final String code, final String type) 
	{
		...
		HttpUtil.sendHttpRequest(address, new HttpCallbackListener(){
			...
			public void onFinish(String response) 
			{
				...
				result = Utility.handleProvincesResponse(LWeatherDB,
				response);
				} else if ("city".equals(type)) {
				result = Utility.handleCitiesResponse(LWeatherDB,
				response, selectedProvince.getId());
				} else if ("county".equals(type)) {
				result = Utility.handleCountiesResponse(LWeatherDB,
